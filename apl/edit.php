...
<div class="card shadow mb-4">
            ...
            $update =  new Database();
            $update->updateMysql($_POST['namaobat'],$_POST['jenisobat'],$_POST['stokobat'],$_POST['hbobat'],$_POST['hjobat'],$_POST['det1']);
            echo"<h3><center>Data berhasil diubah, cek perubahan pada daftar obat.</center></h3>";
            ?>
        <!-- CONTENT -->
<!-- Footer -->
