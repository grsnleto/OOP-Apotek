...
<?php
    ...
    include("Program.php") ;
    include("obat.php") ;
    include("obatKapsul.php") ;
    include("obatTablet.php") ;
    
    $tampil = new Database();
    $hasil= $tampil->tampilMysql();
...
<tr>
  ...
  <td><?php echo $data['detailObat']; ?></td>
  <td> 
  <a href="prosesedit.php?namaObat=<?php echo $data['namaObat'];?>">Edit</a>
	<a href="proseshapus.php?namaObat=<?php echo $data['namaObat'];?>">Hapus</a>
  </td>
</tr>
<?php
	}
