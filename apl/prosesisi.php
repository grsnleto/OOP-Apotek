...
<div class="card shadow mb-4">
        ...
        $data = $_POST;
        $isi = new Database();
        $isi->isiMysql($data['namaobat'],$data['jenisobat'],$data['stokobat'],$data['hbobat'],$data['hjobat'],$data['det1']);
        echo "<h3><center>Data berhasil disimpan, silahkan lihat di daftar data obat.</center></h3>";
        ?>
        <!-- CONTENT -->
<!-- Footer -->
